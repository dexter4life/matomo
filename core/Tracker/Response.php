...
class Response
{
    ...
    public function outputResponse(Tracker $tracker)
    {
        if (!$tracker->shouldRecordStatistics()) {
            ...
            echo "This resource is part of Matomo. Keep full control of your data with the leading free and open source <a href='https://matomo.org' target='_blank' rel='noopener noreferrer nofollow'>digital analytics platform</a> for web and mobile.";
        } else {
            $this->outputApiResponse($tracker);
